          ...
          <div className="space-y-8 text-gray-600 leading-relaxed font-medium">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>Communication details shared via phone calls, WhatsApp, or website forms</li>
                <li>Any information you voluntarily provide to us for booking or support purposes</li>
              </ul>
              <p className="mt-4 text-sm text-gray-500">We do not intentionally collect sensitive personal data unless required to provide our services.</p>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 text-sm text-gray-500">We do not use your personal information for unsolicited marketing.</p>
            </div>
            ...
            <div>
              ...
              <p>
                We retain your personal and communication data only for as long as necessary to provide services, comply with legal requirements, or resolve disputes.
              </p>
            </div>
