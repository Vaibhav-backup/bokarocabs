      ...
      <div className={`fixed inset-0 bg-black backdrop-blur-2xl transition-all duration-500 ease-in-out ${isMenuOpen ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'} md:hidden z-[99] flex flex-col items-center justify-center gap-10`}>
        ...
        <div className="mt-12 flex flex-col items-center gap-6 border-t border-white/10 pt-12 w-full px-12">
          ...
          <div className="flex gap-6">
            <a href={FACEBOOK_LINK} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-xl hover:bg-[#A3E635] hover:text-black transition-all">
              <i className="fab fa-facebook-f"></i>
            </a>
            <a href={INSTAGRAM_LINK} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-xl hover:bg-[#A3E635] hover:text-black transition-all">
