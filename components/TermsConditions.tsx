          ...
          <div className="space-y-8 text-gray-600 leading-relaxed font-medium">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>Payments must be made as per the agreed mode (cash, UPI, or other accepted methods).</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>Customers must provide accurate pickup and drop details.</li>
                <li>Any changes in trip details should be communicated in advance.</li>
                <li>Customers are responsible for their personal belongings during the journey.</li>
                <li>Smoking, alcohol consumption, and illegal activities are strictly prohibited inside the vehicle.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>Special event and corporate bookings may require advance payment or confirmation.</li>
                <li>Any damage to the vehicle during such bookings will be chargeable to the customer.</li>
              </ul>
            </div>
