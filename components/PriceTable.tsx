    ...
    <section id="pricing" className="py-24 bg-gray-50 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <span className="inline-block bg-yellow-100 text-yellow-700 px-4 py-1 rounded-full text-[10px] font-black tracking-[0.2em] uppercase mb-4">Pricing Guide</span>
        ...
        {loading ? (
          ...
          <>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-primary-blue text-white">
                    ...
                    <th className="p-8 text-xs font-black uppercase tracking-widest text-center bg-primary-yellow text-primary-blue">Sedan (Starts)</th>
                    ...
                    <tr key={idx} className="hover:bg-gray-50/80 transition-colors group">
                      <td className="p-8">
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 rounded-2xl bg-yellow-100 flex items-center justify-center text-primary-yellow group-hover:bg-primary-yellow group-hover:text-primary-blue transition-all">
                      ...
                      <td className="p-8 text-center bg-yellow-50/30">
                        <span className="text-3xl font-black text-gray-900">₹{route.sedan.toLocaleString()}</span>
                        <span className="block text-[10px] font-bold text-yellow-600 uppercase mt-1 tracking-widest">Base Fare</span>
                      </td>
            ...
            <div className="lg:hidden grid grid-cols-1 sm:grid-cols-2 gap-6">
              {routes.map((route, idx) => (
                <div key={idx} className="bg-white rounded-[2rem] p-8 shadow-xl border border-gray-100 hover:border-primary-yellow transition-all transform active:scale-[0.98]">
                  <div className="flex justify-between items-start mb-6">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-2xl bg-primary-yellow text-primary-blue flex items-center justify-center shadow-lg shadow-primary-yellow/20">
                  ...
                  <div className="space-y-4">
                    <div className="bg-yellow-50 p-5 rounded-2xl flex justify-between items-center">
                      <div>
                        <p className="text-[9px] uppercase font-black text-yellow-700 tracking-[0.2em] mb-1">Sedan</p>
        ...
        <div className="mt-12 text-center text-gray-400 font-medium px-6">
          <div className="max-w-xl mx-auto border-t border-gray-100 pt-8 space-y-2">
            ...
            <p className="text-[10px] uppercase font-black tracking-widest text-primary-blue">Verified Service • 24/7 Bokaro Help Desk</p>
          </div>
        </div>
      </div>
    </section>
